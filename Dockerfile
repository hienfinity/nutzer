...
# Aufruf:   docker build --tag juergenzimmermann/nutzer:2026.4.1-hardened .
#               ggf. --no-cache
#
...
#
#           docker debug juergenzimmermann/nutzer:2026.4.1-hardened
#           docker save juergenzimmermann/nutzer:2026.4.1-hardened > nutzer.tar
...
LABEL org.opencontainers.image.title="nutzer" \
    org.opencontainers.image.description="Appserver nutzer mit Basis-Image Bookworm" \
