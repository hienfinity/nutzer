...
def get_by_id(
    ...
    :rtype: Response
    :raises NotFoundError: Falls kein Nutzer gefunden wurde
    """
    user: Final[User] = request.state.current_user
    logger.debug("nutzer_id={}, user={}", nutzer_id, user)
...
def get(
    ...
    :rtype: Response
    :raises NotFoundError: Falls keine Nutzer gefunden wurden
    """
    ...
    nutzer_slice: Final = service.find(suchparameter=suchparameter, pageable=pageable)
